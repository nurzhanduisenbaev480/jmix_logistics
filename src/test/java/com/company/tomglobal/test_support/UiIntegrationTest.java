package com.company.tomglobal.test_support;

import com.company.tomglobal.TomglobalApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.tomglobal.screen")
@ContextConfiguration(classes = {TomglobalApplication.class, UiTestAssistConfiguration.class})
